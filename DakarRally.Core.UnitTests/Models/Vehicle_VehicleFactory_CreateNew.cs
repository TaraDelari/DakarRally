...
{
    public class Vehicle_VehicleFactory_CreateNew
    {
        [Fact]
        public void SportsCar_SportsCarCharacteristics()
        {
            ...
            //act
            Vehicle vehicle = factory.CreateNew(type, teamName, model, manufacturingDate);
        ...
        public void InvalidType_InvalidOperationThrow()
        {
            ...
            //act & assert
            Assert.Throws<InvalidOperationException>(() => factory.CreateNew(type, teamName, model, manufacturingDate));
        }
    }
}